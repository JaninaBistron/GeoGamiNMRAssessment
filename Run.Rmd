...
On the basis of the location-based game [GeoGami](https://geogami.ifgi.de), we created an assessment for measuring navigational map reading (NMR) competencies in children aged six to ten. The assessment addresses competencies in orientating with a map in a real-world environment. We evaluated the assessment by conducting a study with 51 primary school students.
...
For further information on GeoGami (on how to install and use it), see the [GeoGami Website](https://geogami.ifgi.de).
...
The tutorials conducted can be found here: [Tutorial Senden](https://app.geogami.ifgi.de/play-game/game-detail/60bf2fb02e3801b40064c179), [Tutorial Dülmen](https://app.geogami.ifgi.de/play-game/game-detail/60bf2ff72e3801b40064c17b).

The assessment games for these locations can be found here: [GeoGami NMR Assessment Senden](https://app.geogami.ifgi.de/play-game/game-detail/60bf2fe22e3801b40064c17a), [GeoGami NMR Assessment Dülmen](https://app.geogami.ifgi.de/play-game/game-detail/60bf301f2e3801b40064c17c).
